...
var CommentBox = React.createClass({
  ...
  handleCommentSubmit: function(comment) {
          /*since it is slow to have to wait for the request from the server we can optimistically add
          *this comment to the list to make the app feel faster. sp we optimistically set an
          *id on the new comment. it will be replacd by an id generated by the server.
          *
          */
